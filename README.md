...
After pushing v1.3 to GitHub, Railway can redeploy automatically.
...
`/health` should include `"version":"1.3.0"`.

Note: purchase rows already stored by v1.2 keep their old `image_url`. New incoming orders will use the corrected product-image matching.
